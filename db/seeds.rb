...
Product.create!([
  ...
  {rating: 5, description: 'Electronics', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics2', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics3', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics4', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics5', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics6', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics7', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics8', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics9', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics10', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics11', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
  {rating: 5, description: 'Electronics12', title: 'Electronics', price: 35.99, category_id: categories[7].id, user_id: users[0].id},
