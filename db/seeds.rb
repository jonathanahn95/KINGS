...
Product.create!([
  {rating: 5, description: 'This is the best gift I ever got', title: 'Necklace', price: 102.74, category_id: categories[4].id, user_id: users[1].id, style: 1, shipping: 1, location: 2, cost: 1},
  {rating: 5, description: 'I LOVE THESE EARRINGS', title: 'Earrings', price: 35.99, category_id: categories[4].id, user_id: users[0].id, style: 1, shipping: 0, location: 2, cost: 2},
  {rating: 5, description: 'Daddy Necklace to wear around your neck to remember', title: 'Daddy Necklace', price: 35.99, category_id: categories[4].id, user_id: users[0].id, style: 2, shipping: 2, location: 2, cost: 3},
  ...
  {rating: 5, description: 'Wear these beautiful rings out and feel amazing', title: 'Many Rings', price: 50.00, category_id: categories[4].id, user_id: users[0].id, style: 2, shipping: 0, location: 1, cost: 3},
  ...
  {rating: 5, description: 'Skullies that will make you look like you have the real thing around your neck', title: 'Skull Necklace', price: 35.99, category_id: categories[4].id, user_id: users[0].id, style: 2, shipping: 1, location: 1, cost: 1},
  ...
  {rating: 5, description: 'Awesome jesus pieces', title: 'Jesus Piece Necklace', price: 8.99, category_id: categories[4].id, user_id: users[0].id, style: 1, shipping: 2, location: 2, cost: 3},
  ...
  {rating: 5, description: 'Women Shoe', title: 'Women Shoe', price: 25.00, category_id: categories[3].id, user_id: users[0].id, style: 2, shipping: 1, location: 1, cost: 1},
  ...
  {rating: 5, description: 'Supreme', title: 'Supreme Clothing', price: 75.99, category_id: categories[3].id, user_id: users[0].id, style: 1, shipping: 0, location: 2, cost: 3},
  ...
  {rating: 5, description: 'Supreme3', title: 'Supreme Clothing', price: 15.00, category_id: categories[3].id, user_id: users[0].id, style: 1, shipping: 0, location: 2, cost: 1},
  ...
  {rating: 5, description: 'Dress', title: 'Dress', price: 29.99, category_id: categories[3].id, user_id: users[0].id, style: 1, shipping: 2, location: 1, cost: 2},
  ...
  {rating: 5, description: 'Belt', title: 'Belt', price: 100.00, category_id: categories[3].id, user_id: users[0].id, style: 1, shipping: 1, location: 1, cost: 4},
  ...
  {rating: 5, description: 'Custom made nike show', title: 'Shoe', price: 90.00, category_id: categories[3].id, user_id: users[0].id, style: 2, shipping: 2, location: 1, cost: 3},
  ...
  {rating: 5, description: 'Art 2', title: 'Art', price: 35.99, category_id: categories[1].id, user_id: users[1].id, style: 2, shipping: 0, location: 1, cost: 1},
  {rating: 5, description: 'Art 3', title: 'Art', price: 33.00, category_id: categories[1].id, user_id: users[0].id, style: 1, shipping: 1, location: 1, cost: 2},
  ...
  {rating: 5, description: 'Art 6', title: 'Art', price: 65.00, category_id: categories[1].id, user_id: users[1].id, style: 2, shipping: 0, location: 1, cost: 1},
  ...
  {rating: 5, description: 'Art 8', title: 'Art', price: 50.00, category_id: categories[1].id, user_id: users[1].id, style: 2, shipping: 0, location: 1, cost: 3},
  ...
  {rating: 5, description: 'Art 10', title: 'Art', price: 150.50, category_id: categories[1].id, user_id: users[0].id, style: 2, shipping: 0, location: 2, cost: 1},
  ...
  {rating: 5, description: 'Art 12', title: 'Art', price: 12.00, category_id: categories[1].id, user_id: users[0].id, style: 2, shipping: 0, location: 2, cost: 3},
  {rating: 5, description: 'Electronics', title: 'Electronics', price: 57.00, category_id: categories[7].id, user_id: users[0].id, style: 1, shipping: 1, location: 1, cost: 4},
  ...
  {rating: 5, description: 'Electronics3', title: 'Electronics', price: 59.99, category_id: categories[7].id, user_id: users[0].id, style: 1, shipping: 0, location: 1, cost: 2},
  ...
  {rating: 5, description: 'Electronics5', title: 'Electronics', price: 75.70, category_id: categories[7].id, user_id: users[0].id, style: 2, shipping: 2, location: 2, cost: 4},
  ...
  {rating: 5, description: 'Electronics7', title: 'Electronics', price: 299.00, category_id: categories[7].id, user_id: users[0].id, style: 1, shipping: 2, location: 2, cost: 2},
  ...
  {rating: 5, description: 'Electronics10', title: 'Electronics', price: 22.25, category_id: categories[7].id, user_id: users[0].id, style: 2, shipping: 1, location: 1, cost: 1},
  {rating: 5, description: 'Electronics11', title: 'Electronics', price: 18.75, category_id: categories[7].id, user_id: users[0].id, style: 1, shipping: 0, location: 1, cost: 2},
  {rating: 5, description: 'Electronics12', title: 'Electronics', price: 91.90, category_id: categories[7].id, user_id: users[0].id, style: 2, shipping: 2, location: 2, cost: 3},
  ...
  {rating: 5, description: 'Sports2', title: 'Sports', price: 35.99, category_id: categories[2].id, user_id: users[0].id, style: 1, shipping: 0, location: 2, cost: 1},
  {rating: 5, description: 'Sports3', title: 'Sports', price: 39.99, category_id: categories[2].id, user_id: users[0].id, style: 1, shipping: 1, location: 2, cost: 2},
  ...
  {rating: 5, description: 'Sports5', title: 'Sports', price: 9.75, category_id: categories[2].id, user_id: users[0].id, style: 1, shipping: 2, location: 1, cost: 4},
  ...
  {rating: 5, description: 'Sports7', title: 'Sports', price: 20.00, category_id: categories[2].id, user_id: users[0].id, style: 2, shipping: 1, location: 2, cost: 2},
  ...
  {rating: 5, description: 'Sports9', title: 'Sports', price: 35.99, category_id: categories[2].id, user_id: users[0].id, style: 2, shipping: 1, location: 1, cost: 4},
  {rating: 5, description: 'Sports10', title: 'Sports', price: 16.75, category_id: categories[2].id, user_id: users[0].id, style: 1, shipping: 0, location: 1, cost: 1},
  ...
  {rating: 5, description: 'Sports11', title: 'Sports', price: 102.74, category_id: categories[2].id, user_id: users[0].id, style: 1, shipping: 0, location: 1, cost: 3}
  ])
